            ...
            <div class="single-post row">
              <div class="col-lg-3  col-md-3 meta-details">
                ...
                <div class="user-details row">
                  <p class="user-name col-lg-12 col-md-12 col-6"><a href="#">Testimonio registrado:</a> </span></p>
                  <p class="date col-lg-14 col-md-12 col-8"><a href="#">{{$vertestimonios{0}->created_at}}</a> <span class="lnr lnr-calendar-full"></span></p>
                </div>
              </div>
              <div class="col-lg-9 col-md-9 ">
                <div class="feature-img">
                  <img class="img-fluid" src="{{asset('/img/testimonios/'.$vertestimonios{0}->imagen)}}" alt="">
                </div>
                <a class="posts-title" ><h3>{{$vertestimonios{0}->titulo}}</h3></a>
                <p class="excert">
                  {{$vertestimonios{0}->contenido}}
                </p>
               </div>
            </div>
